(module
 ...
 (export "abort" (func $assembly/contracts/MemeToken/abort))
 ...
 (func $~lib/@btc-vision/btc-runtime/runtime/types/Address/Address#constructor (param $0 i32) (param $1 i32) (result i32)
  ...
  if
   ...
   if
    ...
    i32.store
    block $__inlined_func$~lib/util/string/joinReferenceArray<~lib/string/String>$7 (result i32)
     i32.const 0
     local.set $1
     i32.const 2304
     i32.const 1948
     ...
     i32.const 0
     i32.lt_s
     br_if $__inlined_func$~lib/util/string/joinReferenceArray<~lib/string/String>$7
     drop
     local.get $2
     i32.eqz
     if
      ...
      local.get $0
      select
      br $__inlined_func$~lib/util/string/joinReferenceArray<~lib/string/String>$7
     end
     i32.const 2304
     local.set $0
     i32.const 2300
 ...
 (func $assembly/contracts/MemeToken/abort (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
 )
 (func $~start
  (local $0 i32)
  global.get $~started
  ...
  call $~lib/@btc-vision/as-bignum/assembly/integer/i128/i128#constructor
  block $__inlined_func$start:~lib/@btc-vision/btc-runtime/runtime/secp256k1/ECPoint$44
   block $folding-inner0
    ...
    i64.load offset=24
    call $~lib/@btc-vision/as-bignum/assembly/integer/u256/u256#constructor
    br $__inlined_func$start:~lib/@btc-vision/btc-runtime/runtime/secp256k1/ECPoint$44
   end
   i32.const 1728
   i32.const 5504
   i32.const 169
