...
import { EcKeyPair, TransactionFactory, Mnemonic, MLDSASecurityLevel, AddressTypes } from "@btc-vision/transaction";
...
if (!MNEMONIC) { console.error("MNEMONIC is required"); process.exit(1); }
...
console.log("Done!");import { JSONRpcProvider } from "opnet";
